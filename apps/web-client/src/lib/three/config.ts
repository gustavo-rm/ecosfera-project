...
/** Uma volta completa do planeta entre 8 e 15 min (requisito). Usamos ~11 min. */
export const PLANET_ROTATION_PERIOD_S = 11 * 60;
/** Nuvens giram um pouco mais rápido para gerar sensação de profundidade. */
export const CLOUD_ROTATION_PERIOD_S = 8.5 * 60;
...
/** Janela aleatória de surgimento de novos focos de vida (segundos). */
